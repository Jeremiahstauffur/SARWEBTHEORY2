...
$bottomNavTemplate = @"
    <nav class="bottom-nav">
      <div class="bottom-nav-main">
        ...
        <a href="page2.html" class="{ACTIVE_PAGE2}">
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M12 2L2 9l4 11h12l4-11-10-7z"></path></svg>
          <span>Segments</span>
        </a>
        <a href="page3.html" class="{ACTIVE_PAGE3}">
        ...
        <a href="page4.html" class="{ACTIVE_PAGE4}">
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><line x1="8" x2="21" y1="6" y2="6"></line><line x1="8" x2="21" y1="12" y2="12"></line><line x1="8" x2="21" y1="18" y2="18"></line><line x1="3" x2="3.01" y1="6" y2="6"></line><line x1="3" x2="3.01" y1="12" y2="12"></line><line x1="3" x2="3.01" y1="18" y2="18"></line></svg>
          <span>Log</span>
        </a>
        <a href="#" onclick="event.preventDefault(); this.closest('.bottom-nav').classList.toggle('expanded');">
      ...
      <div class="bottom-nav-extra">
        ...
        <a href="page6.html" class="{ACTIVE_PAGE6}">
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
          <span>Incident</span>
        </a>
        <a href="page7.html" class="{ACTIVE_PAGE7}">
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
          <span>Uploads</span>
        </a>
        <a href="settings.html" class="{ACTIVE_SETTINGS}">
        ...
        <a href="#" onclick="event.preventDefault(); document.getElementById('profile-btn').click(); this.closest('.bottom-nav').classList.remove('expanded');">
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
          <span>Profile</span>
        </a>
        <a href="#" onclick="event.preventDefault(); document.getElementById('notif-bell').click(); this.closest('.bottom-nav').classList.remove('expanded');">
