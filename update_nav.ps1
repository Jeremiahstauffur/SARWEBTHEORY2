...
$bottomNavTemplate = @"
    <nav class="bottom-nav">
      ...
      <a href="#" onclick="event.preventDefault(); this.parentElement.scrollTo({left: this.offsetLeft - 20, behavior: 'smooth'});">
      ...
      <a href="#" onclick="event.preventDefault(); document.getElementById('profile-btn').click();">
      ...
      <a href="#" onclick="event.preventDefault(); document.getElementById('notif-bell').click();">
